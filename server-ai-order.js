...
module.exports = function attachAiOrderEndpoints(app, deps = {}) {
  const verifyInitDataMiddleware = deps.verifyInitDataMiddleware;
  const getInitDataFromReq = deps.getInitDataFromReq;
